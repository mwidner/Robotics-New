...
public class MecanumDaniel_GyroControl_aut extends LinearOpMode {
    ...
    private double leftSXCorrected = 0;
    private double leftSYCorrected = 0;
    private double controllerAngle = 0;
    private double controllerPower = 0;
    
    private double lSXOverride = 0;
    private double lSYOverride = 0;
    private double rSXOverride = 0;
    
    private double lSYOverrideNeg = 0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            //Autonomous Controller Emulation Override
            lSYOverrideNeg = -lSYOverride;
            
            if(lSXOverride != 0){
                leftStickX = lSXOverride;
            }
            if(lSYOverrideNeg != 0){
                leftStickY = lSYOverrideNeg;
            }
            if(rSXOverride != 0){
                rightStickX = rSXOverride;
            }
            
            
            controllerPower = 0 - leftStickY;
            controllerAngle = getAngle();
            ...
            if(correctionEnabled == true){
                ...
                mecDrive(leftStickY*5,rightStickX*5,leftStickX*0.8);
            }
