...
@Autonomous(name = "SuperBot Project", group = "Autonomous")

public class AutoFinal_superbot extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            }else if(autoTimer>28.6){
                leftStickY = 1;
                servoState = true;
            }else if(autoTimer>27.4){
                servoState = false;
                leftStickY = 0.3;
            }else if(autoTimer>26.8){
                leftStickY = -1;
            }else if(autoTimer>25){
                leftStickX = -1;
            }else if(autoTimer>24.9){
                servoState = true;
            }else if(autoTimer>23){
                leftStickX = 1;
            }
